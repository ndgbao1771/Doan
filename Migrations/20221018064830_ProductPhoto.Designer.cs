...
namespace AppMVC.Net.Migrations
{
    ...
    [Migration("20221018064830_ProductPhoto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.Products.CategoryProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Models.Products.ProductCategoryProduct", b =>
                {
            ...
            modelBuilder.Entity("App.Models.Products.ProductModel", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Models.Products.CategoryProduct", b =>
                {
                    b.HasOne("App.Models.Products.CategoryProduct", "ParentCategory")
                        .WithMany("CategoryChildren")
                        .HasForeignKey("ParentCategoryId");
            ...
            modelBuilder.Entity("App.Models.Products.ProductCategoryProduct", b =>
                {
                    b.HasOne("App.Models.Products.CategoryProduct", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Models.Products.ProductModel", "Product")
