...
namespace App.Areas.Database.Controllers
{
    ...
    public class DbManageController : Controller
    {
        ...
        private void SeedProductCategory()
        {
            ...
            fakerProduct.RuleFor(p => p.DateCreated, f => f.Date.Between(new DateTime(2022,1,1), new DateTime(2022,10,1)));
        ...
        private void SeedPostCategory()
        {
            ...
            fakerPost.RuleFor(p => p.DateCreated, f => f.Date.Between(new DateTime(2022,1,1), new DateTime(2022,10,1)));
