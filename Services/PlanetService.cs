...
namespace App.Services
{
    public class PlanetService : List<PlanetModel>
    {
        ...
        {
            Add(new PlanetModel() {
                Id = 1, Name = "Mercury", VnName = "Sao Thủy", 
